...
public class UserController {
    ...
    @PutMapping("/info")
    public ResponseEntity<ApiResponse> updateMyInfo(Authentication authentication,
    ...
    public ResponseEntity<ApiResponse> changeMyPassword(Authentication authentication,
