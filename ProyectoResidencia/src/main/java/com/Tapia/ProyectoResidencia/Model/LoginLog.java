...
public class LoginLog {
    ...
    private Long idUsuario; //Id del usuario que está haciendo la acción (puede ser null para inicios de sesión fallidos)
    ...
    @Enumerated(EnumType.STRING)
    private Resultado resultado; //Si se logro iniciar sesión o si hubo error en la contraseña, o se ingreso con un correo que no existe

    private String descripcion; //Alguna posible anotación extra

    private String ip;//Ip de origen desde donde se esta realizando la acción (esto es opcional, si es posible recuperar la ip)
